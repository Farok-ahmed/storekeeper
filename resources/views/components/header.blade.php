                        ...
                        <ul class="header-notification-area">
                            ...
                            <li class="adomx-dropdown position-relative col-auto">
                                ...
                                <ul class="adomx-dropdown-menu dropdown-menu-language">
                                    ...
                                    <li><a href="#"><img src="{{ asset('assets/') }}/images/flags/flag-2.jpg" alt=""> Japanese</a></li>
                                    <li><a href="#"><img src="{{ asset('assets/') }}/images/flags/flag-3.jpg" alt=""> Spanish </a></li>
                                    <li><a href="#"><img src="{{ asset('assets/') }}/images/flags/flag-4.jpg" alt=""> Germany</a></li>
                                </ul>
